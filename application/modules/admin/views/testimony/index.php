                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="<?= base_url($edit . $row->id_testimony)  ?>"><i class="fa fa-edit"></i> Edit</a></li>
                                    <li><a class="tombol-hapus" href="<?= base_url($delete . $row->id_testimony)  ?>"><i class="fa fa-trash"></i> Hapus</a></li>
                                </ul>
                            </div>
